...
class ConversationTableViewCell: UITableViewCell
{
    ...
    override func layoutSubviews()
    {
        ...
        lastMessageLabel.setRelativePosition(.relativePositionUnderAlignedLeft, toView: usernameLabel, margins: .top(verticalMargin), size: CGSize(width: lastMessageWidth, height: lastMessageLabel.sizeThatFits(CGSize(width: lastMessageWidth, height: height)).height))
    }
